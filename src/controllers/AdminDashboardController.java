...
public class AdminDashboardController implements Initializable {
    ...
    public void setAdmin(Admin admin) {
        ...
        chargerRendezVous();
        chargerStatistiques(); // cette ligne si nécessaire pour les graphiques
        mettreAJourCompteurs(); //pour les labels
        afficherTableRdvDansMainContent(); //  pour afficher les données


    }
/*pour afficher le nom d'admin en majuscule(juste les premiers lettres de noms et prénoms*/
    private static String capitalize(String str) {
        if (str == null || str.isEmpty()) return str;
        return str.substring(0, 1).toUpperCase() + str.substring(1).toLowerCase();
    }
/*pour donner les info d'admin dans l'interface*/
...

            {
                ...
                btnVoir.setOnAction(event -> {
                    ...
                    try {
                        ...
                        RendezVousAdminController controller = loader.getController();
    ...
    private void handleTraitements() {
        try {
            ...
            TraitementsAdminController controller = loader.getController();
            if (admin != null) {
                controller.setAdminId(admin.getId());
            }
    ...
    public void rafraichirTableauRendezVous() {
        List<RendezVous> rdvFuturs = rendezVousDAO.getDerniersRendezVous(7, admin.getId());
    ...
    private void handleDemandesButtonAction() {
        try {
            ...
            DemandeRendezVousAdminController controller = loader.getController();
            if (admin != null) {
                controller.setAdminId(admin.getId());
            }
